...
public class NettyClientConnect implements NetConnect {
    ...
    public boolean connect() {
        try {
            ...
            logger.info("Connect:local {} remote {} success",localAddress.toString(),remoteAddress.toString());
            return true;
        }catch(Exception e) {
            this.close();
            logger.error("Connect:"+remoteAddress.toString(),e);
            return false;
        }
    }
    ...
    public void close() {
        ...
        logger.info("Connect:{} connect {} close",remoteAddress.toString());
    }
    @Override
