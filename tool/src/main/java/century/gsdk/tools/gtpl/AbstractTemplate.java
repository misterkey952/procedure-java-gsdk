...
public abstract class AbstractTemplate {
    ...
    public void outputXML()throws Exception{
        ...
        ToolLogger.GTPL.info("{} output a XML file ,name={},category={}",this.getClass().getSimpleName(),name,category);
    }
    ...
    public void inputXML()throws Exception{
        ...
        ToolLogger.GTPL.info("{} input a XML file ,name={},category={}",this.getClass().getSimpleName(),name,category);
    }
    ...
    public void outputODS() throws Exception {
        ...
        ToolLogger.GTPL.info("{} output a ODS file ,name={},category={}",this.getClass().getSimpleName(),name,category);
    }
    ...
    public void inputODS() throws Exception {
        ...
        odsCoder.encode(this);
        ToolLogger.GTPL.info("{} input a ODS file ,name={},category={}",this.getClass().getSimpleName(),name,category);
    }
